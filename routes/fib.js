...
router.get('/reference_pathogens', (req, res)=>{
    var reference_pathogens = [
        {pathogen:"Cryptosridium Parvum", best_fit_model:"exponential", parameter:[{r:0.059}]},
        ...
        {pathogen:"Giardia lambia", best_fit_model:"exponential", parameter:[{r:0.0199}]},
        {pathogen:"Entamoeba coli", best_fit_model:"beta-poisson", parameter:[{alpha:0.101, beta:341}]}
    ]
