...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2023 at 02:21 PM
...
INSERT INTO `events` (`id`, `title`, `description`, `date`, `venue`, `image`) VALUES
(4, 'pictures', 'testing', '2023-12-12', 'tut', 'http://localhost:3001/api/uploads/1699952152120.jpg'),
(5, 'presentation', 'progress report', '2023-12-14', 'tut', 'http://localhost:3001/api/uploads/1699952343345.jpg'),
(6, 'wdfgb', 'dsfvb ', '0000-00-00', 'sdfb', 'http://localhost:3001/api/uploads/1699965684220.jpg'),
(7, 'adsfb', 'sfgvbgv', '0000-00-00', 'sfvb ', 'http://localhost:3001/api/uploads/1699967816870.jpg'),
(8, 'wedety', 'reh', '0000-00-00', 'etg', '');
